...
void update_gui(SDL_Window* window, SDL_GLContext gl_context, ImVec4 clear_color, ImGuiIO& io,ImFont *fonty, bool show_demo_window, bool show_another_window){
...
int main(int, char**)
{
    ...
    io.Fonts->AddFontDefault();
    ImFont *fonty = io.Fonts->AddFontFromFileTTF("Park Tech CG.ttf", 65.0f);
...
#endif
    {
        switch (board.state) {
            ...
            case game::playing:{
                ...
                update_gui(window, gl_context, clear_color,io,fonty, show_demo_window, show_another_window);
            } break;
            case game::finished:{
                done = true;
            } break;
